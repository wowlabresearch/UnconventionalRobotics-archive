...
const rawProjects = [
  {
    ...
    <h3>Project Overview</h3>
      ...
      <ul>
        ...
        <li><strong>Contact Sensor:</strong> The surface of the end-effector is wrapped with a copper plate connected to an ESP32 via Bluetooth to detect physical contact.</li>
      </ul>
  ...
  
  {
    ...
    blogContent: `
      ...
      <ul>
        <li><strong>Hybrid Structure:</strong> The body integrates the Kresling pattern, which provides torsional stiffness and load-bearing capability, with the accordion pattern, which contributes large axial deformation and compliance.</li>
      ...
      <ul>
        <li><strong>Browser-Based Pipeline:</strong> The user interface operates entirely within a web browser, utilizing p5.js for 3D simulation and ml5.js for vision-based hand tracking.</li>
        <li><strong>Direct Communication:</strong> The browser connects directly to an ESP32 microcontroller via the Web Serial API, enabling low-latency data exchange without requiring a dedicated server.</li>
        <li><strong>Control Strategy Evolution:</strong> To balance stability and intuitiveness in an open-loop system, we explored multiple strategies ranging from proportional hand mapping to threshold-based binary control.</li>
        <li><strong>AI-based Inverse Kinematics:</strong> We ultimately explored a multilayer perceptron (MLP) neural network approach that predicts the required actuator commands based on user-specified 3D target positions.</li>
      </ul>
  ...
  
  {
    ...
    <img src="./assets/2025/thumbnails/LIMERO-Thumbnail.gif" " width="80%">
      ...
      <div style="text-align: center; margin: 20px 0;">
        <img src="./assets/2025/fig/LIMERO-hw3.png" alt=" " width="80%">
      <img src="./assets/2025/fig/LIMERO-hw4.png" alt=" " width="80%">
      </div>
      ...
      <div style="text-align: center; margin: 20px 0;">
      <img src="./assets/2025/fig/LIMERO-hw.png" alt=" " width="80%">
      </div>
      ...
      <div style="text-align: center; margin: 20px 0;">
      <img src="./assets/2025/fig/LIMERO-hw2.png" alt=" " width="80%">
      <img src="./assets/2025/fig/LIMERO-system.png" alt=" " width="80%">
      </div>
      ...
      <ul>
        ...
        <li><strong>Frontend Visualization:</strong> Through Socket.IO communication and Chart.js, the system visualizes real-time emotional trends and dynamically changes the color of the robot's 'Aura' effect.</li>
